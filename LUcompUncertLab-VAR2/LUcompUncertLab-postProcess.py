...
class postprocess(object):
    ...
    def boundBelowByZero(self):
        import pandas as pd
        d = pd.read_csv("{:s}-LUcompUncertLab-VAR2-preprocess.csv".format(self.forecast_date))
    ...
    def writeOut(self):
        self.d.to_csv("{:s}-LUcompUncertLab-VAR2.csv".format(self.forecast_date),index=False)
